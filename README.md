...
See `AGENTS.md` for the high-level brief, `docs/CONVENTIONS.md` for the cited rules, `docs/decisions/` for the architectural decision lock that initiated the port.
